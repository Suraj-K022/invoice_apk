...
class SalesByCustomer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: [
          InkWell(onTap: (){Get.to(CopyOfSalesScreen(appbarTitle: 'Sales by Customer PDF',));},child: Image.asset(Images.w1,height: 24,width: 24,)),
          SizedBox(width: 20,)
        ],
        leading: IconButton(
      ...
      body: ListView(padding: EdgeInsets.symmetric(horizontal: 20),
        children: [
          ...
          Poppins(text: 'Sales by Customer',fontWeight: FontWeight.w500,fontSize: 14,color: Get.theme.hintColor,textAlign: TextAlign.center,),
...
Divider(height: 0,color: Get.theme.hintColor.withOpacity(0.2),thickness: 1,),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
              ...
              Poppins(text: '₹ 1,740.00',fontWeight: FontWeight.w500,fontSize: 14,color: Get.theme.canvasColor,)
            ],),
          ),
          Divider(height: 0,color: Get.theme.hintColor.withOpacity(0.2),thickness: 1,),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
              Poppins(text: 'Mr. Piyush Soni',fontWeight: FontWeight.w500,fontSize: 14,color: Get.theme.canvasColor,),
              Poppins(text: '₹ 108.00',fontWeight: FontWeight.w500,fontSize: 14,color: Get.theme.canvasColor,)
            ],),
          ),
          Divider(height: 0,color: Get.theme.hintColor.withOpacity(0.2),thickness: 1,),
